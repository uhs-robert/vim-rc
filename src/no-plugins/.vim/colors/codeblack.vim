...
let s:cdBack = {'gui': '#000000', 'cterm': s:cterm00, 'cterm256': '256'}
if g:codedark_transparent | let s:cdBack = {'gui': 'NONE', 'cterm': 'NONE', 'cterm256': 'NONE'} | endif

let s:cdTabCurrent = {'gui': '#084671', 'cterm': s:cterm00, 'cterm256': '175'}
let s:cdTabOther = {'gui': '#3E3C3B', 'cterm': s:cterm01, 'cterm256': '236'}
